		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ecastellamyapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ecastellamyapp-display": {
								"semanticObject": "ecastellamyapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ecastella.myapp",
									"url": sap.ui.require.toUrl("ecastella/myapp")
								}
							}
						}
					}
